...
settings.nom_FA = 3*pi/180; % Nominal Image Train Flip Angle in Radians
...
settings.Dummy_RF = 0; % Add 'dummy' RF pulses prior to reference image train which help achieve steady-state
